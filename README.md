...
As a first step, you have to reverse engineer the **`log_message`** function by manually disassembling it, writing down its functionality in pseudocode, and drawing its stack layout. 
Keep an eye open for any bug you might discover here (hint). 
We give you an example of the **`get_file_name`** function. 
...
1. a live demonstration of the working exploits. For this demo, you have to connect to our private network over Ethernet and attack a real remote server. Bring an Ethernet adapter if your laptop does not have an Ethernet connection.
